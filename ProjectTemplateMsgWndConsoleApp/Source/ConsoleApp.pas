...
uses
    Classes, SysUtils, Windows, ToolsApi, Dialogs;
...
begin
    Result := LoadIcon(HInstance, 'APPICON');
end;
...
begin
    Result := 'Creates a new console application.';
end;

function TMsgWndAppProjectWizard.GetIDString: string;
begin
    Result := 'EvilWorks.ConsoleApp';
end;
